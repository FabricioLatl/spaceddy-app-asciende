...
class CreateListingWidget extends StatefulWidget {
  const CreateListingWidget({Key? key}) : super(key: key);

  @override
  _CreateListingWidgetState createState() => _CreateListingWidgetState();
}
...
class _CreateListingWidgetState extends State<CreateListingWidget> {
  ...
  void initState() {
    ...
    _model.precioController1 ??= TextEditingController();
    _model.precioController2 ??= TextEditingController();
  }
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelStyle: FlutterFlowTheme.of(context).bodySmall,
                    hintText: 'Descripcion del listado',
                    hintStyle: FlutterFlowTheme.of(context).bodySmall,
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                        color: FlutterFlowTheme.of(context).primaryBackground,
              ...
              Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  hintText: 'Selecciona el tipo de inmueble',
                  icon: Icon(
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                child: TextFormField(
                  controller: _model.precioController1,
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText:
                        'Precio  (por mes en alquiler, o completo en venta)',
                  ...
                  maxLines: null,
                  validator:
                      _model.precioController1Validator.asValidator(context),
                ),
              ),
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                child: TextFormField(
                  controller: _model.precioController2,
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'superficie (metros cuadrados)',
                    labelStyle: FlutterFlowTheme.of(context).bodySmall.override(
                          fontFamily: 'Poppins',
                          fontSize: 12.0,
                        ),
                  ...
                  maxLines: null,
                  validator:
                      _model.precioController2Validator.asValidator(context),
                ),
              ),
              Padding(
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 9.0, 5.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              Padding(
                ...
                child: FlutterFlowPlacePicker(
                  iOSGoogleMapsApiKey:
                      'AIzaSyC1KryEs7S9NMXuOsALzz8XJ3z6uoHcHlM',
                  androidGoogleMapsApiKey:
                      'AIzaSyBGBH1eJrB-XvtmJ2udBBnLUet1JYRdqM8',
                  webGoogleMapsApiKey:
                      'AIzaSyBo8OYC9gDvQV-Yo_5loRAKMq-o9QG3Xqs',
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      final nonFeaturedListingsCreateData = {
                        ...createNonFeaturedListingsRecordData(
                          name: _model.yourNameController.text,
                          price: double.tryParse(_model.precioController1.text),
                          tipoDeInmueble: _model.precioController1.text,
                          numeroDormitorios: _model.countControllerValue3,
                          numeroBanos: _model.countControllerValue1,
                          enConstruccion: false,
                          numeroEstacionamientos: _model.countControllerValue4,
                          superficie:
                              double.tryParse(_model.precioController2.text),
                          antiguedad: _model.countControllerValue1,
                          location: _model.placePickerValue.latLng,
                          description: _model.myBioController.text,
                          userThatCreated: currentUserReference,
                        ),
                        'images': _model.uploadedFileUrls2,
                      };
                      await NonFeaturedListingsRecord.collection
                          .doc()
                          .set(nonFeaturedListingsCreateData);
