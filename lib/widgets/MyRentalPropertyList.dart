...
class MyRentalPropertyList extends StatefulWidget {
  final propartyImage;
  final propartyName;
  ...
  final hasNavigat;
  final routeName;
  const MyRentalPropertyList({Key? key,
    this.propartyImage = '',
    this.propartyName = '',
  ...
  @override
  State<MyRentalPropertyList> createState() => _MyRentalPropertyListState();
}

class _MyRentalPropertyListState extends State<MyRentalPropertyList> {
  bool likeBtn = false;
  @override
