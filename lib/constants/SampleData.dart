...
final destinationSliderList = [
  ...
  DestinationSliderModal(
    propertyImage: houseImage1,
    propertyName: 'Casa 1',
    propertyLocation: 'San isidro, Lima, Peru',
    propertyRatingText: '4.8',
  ),
  DestinationSliderModal(
    propertyImage: houseImage2,
...
final flatDestinationSliderList = [
  DestinationSliderModal(
    ...
    propertyName: 'Departamento 4',
    propertyLocation: 'San isidro, Lima, Peru',
    propertyRatingText: '4.8',
  ),
  DestinationSliderModal(
    propertyImage: flatImage2,
    propertyName: 'Departamento 5',
    propertyLocation: 'San isidro, Lima, Peru',
    propertyRatingText: '4.8',
  ),
  DestinationSliderModal(
    propertyImage: flatImage1,
    propertyName: 'Departamento 1',
    propertyLocation: 'San isidro, Lima, Peru',
    propertyRatingText: '4.8',
  ),
  DestinationSliderModal(
    propertyImage: flatImage2,
    propertyName: 'Departamento 2',
    propertyLocation: 'San isidro, Lima, Peru',
    propertyRatingText: '4.8',
  ),
];
...
final propertyColumnList = [
  ...
  CategoryListModal(
    ...
    propartyName: 'Casa 4',
    propartyLocation: 'San isidro, Lima, Peru',
    propartyRentText: 'S/. 200, 000',
    propartyRatingText: '4.8',
    facilityList: facilityList,
  ),
  CategoryListModal(
