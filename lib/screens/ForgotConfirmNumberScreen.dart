...
class ForgotConfirmNumberScreen extends StatefulWidget {
  const ForgotConfirmNumberScreen({Key? key}) : super(key: key);

  @override
  State<ForgotConfirmNumberScreen> createState() => _ForgotConfirmNumberScreenState();
}

class _ForgotConfirmNumberScreenState extends State<ForgotConfirmNumberScreen> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: CommonBtn(
                      ...
                      hasNavigat: true,
                      routeName: route.kResetPasswordScreenRoute,
                    ),
                  ),
                ],
              ),
